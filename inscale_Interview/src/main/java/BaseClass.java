...
public class BaseClass {
    ...
    public static void chromeSetup(){
        //to setup and launch chrome browser
        driver = new ChromeDriver();
        System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\ChromeBrowser\\chromedriver.exe");
        driver.manage().window().maximize();
        System.out.println("---------Opening chrome is success------------");
    }
